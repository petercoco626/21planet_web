...
export function BadgeInfo() {
  ...
  const { data: badgeHistoryInfo } = useBadgeHistories(BadgeType || 'COMMON_1');
  ...
  return (
    <div>
      ...
      <div className="w-full pl-6 box-border overflow-y-scroll scrollbar-none">
        {badgeHistoryInfo?.data.challenges.map((challenge) => (
